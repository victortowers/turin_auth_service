...
def a_star(start1, end1):
    ...
    while pq:
        ...
        if nodes_explored % 10000 == 0:
            print(f"Distance Remaining is {estimated - distance_travelled:.2f}km, travelled {distance_travelled:.2f}km")
        ...
        #print(f" Trying Candidates {next_candidates}")
        #print(f"Trying next distances{next_weights}")
...
#start = 245374595 # (Aeroporto de Guarulhos)
start = 4137343158 # (Fazenda Boa Vista)
#start = 2868730635 # (Vila Galé Angra dos Reis)
